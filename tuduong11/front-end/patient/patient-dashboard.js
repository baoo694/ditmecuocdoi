import { getPatientRecords } from '../chat/medicalRecordApi.js'
// Global variables
let socket
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (showMedicalBtn && medicalSection) {
    showMedicalBtn.onclick = function () {
      if (
...
async function loadMedicalRecords() {
  try {
    ...
    const data = await getPatientRecords(userId, token)
